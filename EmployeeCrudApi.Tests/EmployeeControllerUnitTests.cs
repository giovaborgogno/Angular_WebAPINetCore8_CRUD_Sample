...
namespace EmployeeCrudApi.Tests
{
    public class EmployeeControllerTests
    {
        ...
        public async Task Create_ReturnsBadRequest_WhenNameIsTooShort()
        {
            ...
            var context = GetInMemoryDbContext();
            var controller = new EmployeeController(context);
            var newEmployee = new Employee { Id = 3, Name = "A" }; // Nombre demasiado corto
            ...
            Assert.Contains("El nombre debe tener al menos dos caracteres.", badRequestResult.Value?.ToString() ?? string.Empty);
        }
        ...
        public async Task Create_ReturnsBadRequest_WhenNameContainsNumbers()
        {
            ...
            var context = GetInMemoryDbContext();
            var controller = new EmployeeController(context);
            var newEmployee = new Employee { Id = 3, Name = "John123" }; // Nombre con números
            ...
            var badRequestResult = Assert.IsType<BadRequestObjectResult>(result);
            Assert.Equal(400, badRequestResult.StatusCode);
            Assert.Contains("El nombre no puede contener números.", badRequestResult.Value?.ToString() ?? string.Empty);
        }
        ...
        public async Task Create_ReturnsBadRequest_WhenNameIsEmpty()
        {
            ...
            var context = GetInMemoryDbContext();
            var controller = new EmployeeController(context);
            var newEmployee = new Employee { Id = 3, Name = "  " };
            ...
            var badRequestResult = Assert.IsType<BadRequestObjectResult>(result);
            Assert.Equal(400, badRequestResult.StatusCode);
            Assert.Contains("El nombre no puede estar vacío o contener solo espacios.", badRequestResult.Value?.ToString() ?? string.Empty);
        }
        ...
        public async Task Create_ReturnsBadRequest_WhenNameIsTrivial()
        {
            ...
            var context = GetInMemoryDbContext();
            var controller = new EmployeeController(context);
            var newEmployee = new Employee { Id = 3, Name = "Empleado" }; // Nombre trivial
            ...
            var badRequestResult = Assert.IsType<BadRequestObjectResult>(result);
            Assert.Equal(400, badRequestResult.StatusCode);
            Assert.Contains("El nombre no puede ser un nombre trivial.", badRequestResult.Value?.ToString() ?? string.Empty);
        }

        [Fact]
        public async Task Update_ReturnsBadRequest_WhenPartsOfNameAreTooShort()
        {
            // Arrange
            var context = GetInMemoryDbContext();
            ...
            var controller = new EmployeeController(context);
            var updatedEmployee = new Employee { Id = 1, Name = "A B" };
            ...
            var badRequestResult = Assert.IsType<BadRequestObjectResult>(result);
            Assert.Equal(400, badRequestResult.StatusCode);
            Assert.Contains("Cada parte del nombre debe contener al menos dos caracteres.", badRequestResult.Value?.ToString() ?? string.Empty);
        }
    }
}
